...
<template>
  <div class="h-full flex flex-col relative mx-auto text-white">
      ...
      >
        ...
        <span
          :class="[
            ...
            activeFilter === filter.label ? 'bg-white/25 text-white' : 'bg-gray-800 text-gray-300'
          ]"
        >
          {{ filter.count }}
        </span>
    ...
    <NuxtLink to="/jobs/new" class="fixed bottom-8 right-8 penta-btn-primary rounded-full p-4 penta-fab transition-transform hover:scale-105 flex items-center justify-center">
